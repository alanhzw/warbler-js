...
- [删除对象数组中某个属性值重复的元素](/guide/array/删除对象数组中某个属性值重复的元素.md)
...
- [计算对象数组中某个属性值的出现次数](/guide/array/计算对象数组中某个属性值的出现次数.md)
- [计算对象数组某个属性值的平均值](/guide/array/计算对象数组某个属性值的平均值.md)
- [计算对象数组某个属性值的总和](/guide/array/计算对象数组某个属性值的总和.md)
